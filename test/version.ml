...
let tests = [
  "version", [
    ...
    "hex", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x012201 Luv.Version.hex);

    "version", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x012201 (Luv.Version.version ()));

    "string", `Quick, (fun () ->
      Alcotest.(check string) "value" "1.34.1" (Luv.Version.string ()));
  ]
]
