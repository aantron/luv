...
let tests = [
  "version", [
    ...
    "minor", `Quick, (fun () ->
      Alcotest.(check int) "number" 43 Luv.Version.minor);
    ...
    "hex", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x012B00 Luv.Version.hex);

    "version", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x012B00 (Luv.Version.version ()));

    "string", `Quick, (fun () ->
      Alcotest.(check string) "value" "1.43.0" (Luv.Version.string ()));
  ]
]
