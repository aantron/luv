...
let tests = [
  "version", [
    ...
    "minor", `Quick, (fun () ->
      Alcotest.(check int) "number" 30 Luv.Version.minor);
    ...
    "hex", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x011E01 Luv.Version.hex);

    "version", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x011E01 (Luv.Version.version ()));

    "string", `Quick, (fun () ->
      Alcotest.(check string) "value" "1.30.1" (Luv.Version.string ()));
  ]
]
