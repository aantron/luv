...
let tests = [
  "version", [
    ...
    "minor", `Quick, (fun () ->
      Alcotest.(check int) "number" 44 Luv.Version.minor);
    ...
    "hex", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x012C02 Luv.Version.hex);

    "version", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x012C02 (Luv.Version.version ()));

    "string", `Quick, (fun () ->
      Alcotest.(check string) "value" "1.44.2" (Luv.Version.string ()));
  ]
]
