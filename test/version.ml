...
let tests = [
  "version", [
    ...
    "minor", `Quick, (fun () ->
      Alcotest.(check int) "number" 36 Luv.Version.minor);
    ...
    "hex", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x012400 Luv.Version.hex);

    "version", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x012400 (Luv.Version.version ()));

    "string", `Quick, (fun () ->
      Alcotest.(check string) "value" "1.36.0" (Luv.Version.string ()));
  ]
]
