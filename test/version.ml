...
let tests = [
  "version", [
    ...
    "minor", `Quick, (fun () ->
      Alcotest.(check int) "number" 39 Luv.Version.minor);
    ...
    "hex", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x012700 Luv.Version.hex);

    "version", `Quick, (fun () ->
      Alcotest.(check int) "number" 0x012700 (Luv.Version.version ()));

    "string", `Quick, (fun () ->
      Alcotest.(check string) "value" "1.39.0" (Luv.Version.string ()));
  ]
]
